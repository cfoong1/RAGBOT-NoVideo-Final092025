...
os.environ["GEMINI_API_KEY"] = "AIzaSyCf_DKBPkqem3M0rRTeoKUVmS7tRUwVUs8"
...
def _resolve_google_api_key():
    ...
    return "AIzaSyCf_DKBPkqem3M0rRTeoKUVmS7tRUwVUs8"
...
def crewai_web_search(url, question):
    ...
    try:
        ...
        gemini_api_key = os.environ.get("GEMINI_API_KEY") or "AIzaSyCf_DKBPkqem3M0rRTeoKUVmS7tRUwVUs8"
...
Provide a comprehensive answer that takes into account information from all the uploaded files."""
        ...
        if st.button("Generate Image(s)", key="img_gen_btn") and prompt_gen:
            ...
            try:
                ...
                VERTEX_API_KEY = "AIzaSyCf_DKBPkqem3M0rRTeoKUVmS7tRUwVUs8"
